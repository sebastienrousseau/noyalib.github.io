...
description: "Release notes for noyalib v0.0.35: machine-checked input budgets, a wasip2 build, a GitHub Action, pre-commit hooks, a VS Code extension, stateless MCP tools."
